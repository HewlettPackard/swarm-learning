...
Create login credentials to access [My HPE Software Center (MSC)](https://myenterpriselicense.hpe.com/cwp-ui/product-details/HPE-SWARM/0.3.0/sw360_eval_customer). The email address used to access MSC is called as HPE passport account. 

The evaluation license for running the Swarm Learning components are available at [My HPE Software Center (MSC)](https://myenterpriselicense.hpe.com/cwp-ui/product-details/HPE-SWARM/0.3.0/sw360_eval_customer). Use your HPE Passport account to access MSC and download evaluation license file.
