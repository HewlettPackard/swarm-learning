...
- Pull the signed Swarm Learning images from HPEs Docker Trust Registry (DTR):
   ```
   docker pull hub.myenterpriselicense.hpe.com/hpe_eval/swarm-learning/sn:1.0.0
   docker pull hub.myenterpriselicense.hpe.com/hpe_eval/swarm-learning/sl:1.0.0
   docker pull hub.myenterpriselicense.hpe.com/hpe_eval/swarm-learning/swci:1.0.0
   docker pull hub.myenterpriselicense.hpe.com/hpe/swarm-learning/swop:1.0.0
   ```
