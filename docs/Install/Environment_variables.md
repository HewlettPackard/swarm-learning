...
|`SL_ENABLE_COMPRESSION`|Controls whether model parameters are compressed using gzip before transmission between SL nodes during synchronization. <br> Default value: False|
